    ...
    room.onPlayerChat = function(player, message) {
        ...
        if (message.includes('!set home team')) {
            ...
            if (availableHomeKits.includes(output[3])) {
                ...
                room.sendAnnouncement('😔 | I don\'t have those kits cuh', null, 0xFF0000, 'bold')
            }
        }
